...
class RegistroEventoPeriodoRepository extends AbstractRepository
{
    ...
    {
        $query = $this->_em->getConnection()->prepare("SELECT public.deletarinformacoescalculo(:stCodContratos,:stTipoFolha,:inCodComplementar,:entidade) as retorno");
        $query->bindValue(':stCodContratos', $stCodContratos, \PDO::PARAM_STR);
        $query->bindValue(':stTipoFolha', $stTipoFolha, \PDO::PARAM_STR);
        $query->bindValue(':inCodComplementar', $inCodComplementar, \PDO::PARAM_STR);
