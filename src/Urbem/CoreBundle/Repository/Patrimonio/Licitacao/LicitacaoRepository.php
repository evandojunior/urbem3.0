...
SQL;
    ...
    public function getByTermAsQueryBuilder($term)
    {
        ...
        $like = $qb->expr()->like('string(Licitacao.codLicitacao)', ':term');
        $orx->add($like);

        $like = $qb->expr()->like('Licitacao.exercicio', ':term');
        $orx->add($like);

        $like = $qb->expr()->like("CONCAT(string(Licitacao.codLicitacao), '/', Licitacao.exercicio)", ':term');
        $orx->add($like);
