...
class LancamentoModel extends AbstractModel
{
    ...
    public function getArrecadacao(ProxyQuery $proxyQuery, $params)
    {
        ...
        $exercicio = $params['fkArrecadacaoLancamentoCalculos__fkArrecadacaoCalculo__exercicio']['value'] ? :null;
        $cadastroEconomico = $params['fkArrecadacaoLancamentoCalculos__fkArrecadacaoCalculo__fkArrecadacaoCadastroEconomicoCalculo__inscricaoEconomica']['value'] ? :null;
        $inscricaoImobiliaria = $params['fkArrecadacaoLancamentoCalculos__fkArrecadacaoCalculo__fkArrecadacaoImovelCalculo__inscricaoMunicipal']['value'] ? :null;
        $numeracao = $params['fkArrecadacaoLancamentoCalculos__fkArrecadacaoCalculo__fkArrecadacaoPagamentoCalculos__numeracao']['value'] ? :null;
