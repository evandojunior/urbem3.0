...
UrbemSonata = {
    ...
    setFieldErrorMessage: function (suggestedId, message, appendIn) {
        ...
        errorMessageElement += '<span class="close-help-block"><i class="fa fa-times-circle" aria-hidden="true"></i></span>';
    ...
    LoadAutoCompleteInput: function (inputClass, inputNameSearch, urlToSend) {
