...
use Urbem\TributarioBundle\Controller\Arrecadacao\BaixaManualDebitoAdminController;
...
class BaixaManualDebitoAdmin extends AbstractSonataAdmin
{
    ...
    protected $includeJs = ['/tributario/javascripts/arrecadacao/baixa-debitos-manual.js'];
            ...
            ->with('label.baixaDebitos.dadosBaixaManual')
                ...
                ->add(
                    ...
                    [
                        ...
                        'mapped' => false,
                        'data' => sprintf('%s - %s', $cgm->getNumcgm(), $cgm->getNomCgm()),
