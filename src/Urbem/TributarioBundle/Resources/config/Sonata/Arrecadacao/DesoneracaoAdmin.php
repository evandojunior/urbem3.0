...
class DesoneracaoAdmin extends AbstractSonataAdmin
{
    ...
    private function saveRelationships($object)
    {
        ...
        try {
            ...
            if (is_null($fkArrecadacaoAtributoDesoneracoes)) {
                return false;
            }

            foreach ($fkArrecadacaoAtributoDesoneracoes as $atributoDesoneracao) {
                $params = array(
                    'desoneracao' => $object,
                    'atributo' => $atributoDesoneracao
                );

                $atributoDesoneracaoModel->saveAtributoDesoneracao($params);
            }
