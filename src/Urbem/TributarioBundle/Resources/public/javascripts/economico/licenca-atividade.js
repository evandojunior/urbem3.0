$(function () {
    ...
    labelAtividade += ' *';
    $('.select-atividade label').text(labelAtividade);
    labelModelo += ' *';
    ...
    $('.select-modelo').on("click", function () {
        $('.error_modelo').remove();
    });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.length > 0) {
                        ...
                        validaInputAtividade('nao-ha-atividade');
                    }
                    loading(false);
                }
            });
