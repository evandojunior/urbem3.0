...
class PadraoAdmin extends AbstractSonataAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formOptions['horasMensais'] = array(
            'label' => 'label.padrao.horasMensais'
        );
        
        $formOptions['horasSemanais'] = array(
            'label' => 'label.padrao.horasSemanais'
        );
        
        $formOptions['valor'] = array(
            'label' => 'label.padrao.valor',
            'grouping' => false,
            'currency' => 'BRL',
            'attr' => array(
                'class' => 'money '
        ...
        $formOptions['codTipoNorma'] = array(
            'label' => 'label.padrao.codTipoNorma',
