        ...
        if (null == $erro) {
            ...
            if (!empty($contratosNew)) {
                foreach ($contratosNew as $contrato) {
                    $retorno = $contratoModel->montaCalculaFolha($contrato, ContratoModel::IN_COD_CONFIGURACAO, 't', '', $exercicio);
                }
            }
        }
