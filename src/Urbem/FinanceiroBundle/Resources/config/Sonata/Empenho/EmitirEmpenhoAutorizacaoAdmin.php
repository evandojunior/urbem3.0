...
class EmitirEmpenhoAutorizacaoAdmin extends AbstractAdmin
{
    ...
    public function getPreEmpenhoDespesa()
    {
        ...
        $codConta = $entityManager->getRepository("CoreBundle:Orcamento\ContaDespesa")
        ->findOneBy(
            array(
                'exercicio' => $this->getSubject()->getExercicio(),
                'codConta' => $codDespesa->getFkOrcamentoContaDespesa()->getCodConta(),
            )
        );
    ...
    public function getSaldoAnterior()
    {
        ...
        return (float) $preEmpenhoDespesa->saldo_anterior * -1;
    }
