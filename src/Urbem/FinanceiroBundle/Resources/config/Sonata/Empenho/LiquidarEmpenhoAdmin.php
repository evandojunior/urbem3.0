...
use Urbem\CoreBundle\Entity\Contabilidade\Liquidacao;
...
class LiquidarEmpenhoAdmin extends AbstractSonataAdmin
{
    ...
    public function getSearchFilter($queryBuilder, $alias, $field, $value)
    {
        ...
        foreach ($codEmpenhoList as $codEmpenho) {
            ...
            $this->nota[$codEmpenho->cod_empenho] = $codEmpenho->cod_nota;
        }
    ...
    public function preUpdate($object)
    {
        ...
        try {
            ...
            $liquidacao->setFkContabilidadeLancamentoEmpenho($lancamentoEmpenho);
            $liquidacao->setFkEmpenhoNotaLiquidacao($notaLiquidacao);

            $lancamentoEmpenho->setFkContabilidadeLiquidacao($liquidacao);
