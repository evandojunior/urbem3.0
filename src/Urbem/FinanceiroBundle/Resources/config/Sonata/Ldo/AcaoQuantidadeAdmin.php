...
class AcaoQuantidadeAdmin extends AbstractAdmin
{
    ...
    public function validate(\Sonata\CoreBundle\Validator\ErrorElement $errorElement, $object)
    {
        ...
        if ($object->getQuantidade() > (float) $this->getForm()->get('metaDisponivel')->getData()) {
            $mensagem = "O valor da meta não pode ser maior que o valor da meta disponível para o recurso.";
            $errorElement->with('quantidade')->addViolation($mensagem)->end();
