$(document).ready(function() {
    ...
    /*$("button[name='btn_update_and_list']").on('click', function(){
        var id = $("#" + UrbemSonata.uniqId + "_id").val();
        window.open('/financeiro/empenho/liquidar-empenho/'+id+'/show');
        window.open('/financeiro/empenho/liquidar-empenho/reemitir-liquidacao/' + id, 'relatorio');
    });
*/
}());
