$(function()
{
    ...
    $('#form_codEntidade.white.input-rh.browser-default').on('change', function () {
        $('.error_input_entidade').remove();
    });

    $('#form_codGrupo.white.input-rh.browser-default').on('change', function () {
        $('.error_input_grupo').remove();
    });
    ...
    {
        var isSubmit = true,
            codGrupo = $('#form_codGrupo.white.input-rh.browser-default').val(),
            codEntidade = $('#form_codEntidade.white.input-rh.browser-default').val();
