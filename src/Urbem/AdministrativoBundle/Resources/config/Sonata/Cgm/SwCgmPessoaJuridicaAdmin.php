...
class SwCgmPessoaJuridicaAdmin extends SwCgmAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ...
            ->add('nomFantasia', 'text', $fieldOptions['nomFantasia'])
            ->add('cnpj', 'text', $fieldOptions['cnpj'])
            ->add('inscEstadual', 'text', $fieldOptions['inscEstadual'])
            ->add('fkAdministracaoOrgaoRegistro', null, $fieldOptions['fkAdministracaoOrgaoRegistro'])
            ->add('numRegistro', 'text', $fieldOptions['numRegistro'])
            ->add('dtRegistro', 'sonata_type_date_picker', $fieldOptions['dtRegistro'])
            ->add('numRegistroCvm', 'text', $fieldOptions['numRegistroCvm'])
            ->add('dtRegistroCvm', 'sonata_type_date_picker', $fieldOptions['dtRegistroCvm'])
            ->add('objetoSocial', 'textarea', $fieldOptions['objetoSocial'])
            ->end();
