...
class SwCgmPessoaFisicaAdmin extends SwCgmAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $fieldOptions['fkSwPais'] = [
            ...
            'required'     => true,
            'data' => $entityManager->getRepository(SwPais::class)
                ->findOneByCodPais(1)
        ];
        ...
        $fieldOptions['fkSwCategoriaHabilitacao'] = [
            ...
            'choices'      => $entityManager->getRepository(SwCategoriaHabilitacao::class)->findAll(),
        ...
        $formMapper
            ...
            ->add('orgaoEmissor', 'text', $fieldOptions['orgaoEmissor'])
            // fkSwUf: UF do Órgao Emissor
            ->add('fkSwUf', null, $fieldOptions['fkSwUf'])
            ->add('dtEmissaoRg', 'sonata_type_date_picker', $fieldOptions['dtEmissaoRg'])
            ->add('numCnh', 'text', $fieldOptions['numCnh'])
            ->add('fkSwCategoriaHabilitacao', null, $fieldOptions['fkSwCategoriaHabilitacao'])
            ->add('dtValidadeCnh', 'sonata_type_date_picker', $fieldOptions['dtValidadeCnh'])
            ->add('servidorPisPasep', 'text', $fieldOptions['servidorPisPasep'])
            // fkSwPais: Nacionalidade
            ->add('fkSwPais', null, $fieldOptions['fkSwPais'])
            ->add('fkSwEscolaridade', null, $fieldOptions['fkSwEscolaridade'])
            ->add('dtNascimento', 'sonata_type_date_picker', $fieldOptions['dtNascimento'])
